...
builder.Services.AddBuildingBlocks(typeof(Program), typeof(QuraEx.Identity.Infrastructure.Extensions));
...
var publicKeyPem = jwtSection["PublicKeyPem"]
    ?? throw new InvalidOperationException(
        "Jwt:PublicKeyPem required. Set via user-secrets or IDENTITY__JWT__PUBLICKEYPEM.");
