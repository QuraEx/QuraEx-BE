...
using QuraEx.Workspace.Infrastructure;

var builder = WebApplication.CreateBuilder(args);

builder.AddServiceDefaults();
builder.Services.AddWorkspaceInfrastructure(builder.Configuration, builder.Environment);
builder.Services.AddBuildingBlocks(typeof(Program), typeof(QuraEx.Workspace.Infrastructure.Extensions));
...
var publicKeyPem = jwtSection["PublicKeyPem"]
    ?? throw new InvalidOperationException(
        "Jwt:PublicKeyPem required. Set via user-secrets or WORKSPACE__JWT__PUBLICKEYPEM.");
